	...
	$.widget("ech.multiselectfilter", {
		...
		_create: function(){
			var self = this,
				...
				wrapper = (this.wrapper = $('<div class="ui-multiselect-filter">'+(opts.label.length ? opts.label : '')+'<input placeholder="'+opts.placeholder+'" type="search"' + (/\d/.test(opts.width) ? 'style="width:'+opts.width+'px"' : '') + ' /></div>').appendTo( this.header ));
